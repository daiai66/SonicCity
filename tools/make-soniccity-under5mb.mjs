...
const output = "SonicCity_under5mb.html";

const replacements = [
  { path: "city-sound-mart-mobile.png", mime: "image/png" },
  { path: "assets/textures/earth-nightmap-inline-visible-2048.jpg", mime: "image/jpeg" },
  { path: "csm-ultra-earth-normal.png", mime: "image/png" },
  { path: "csm-night-lights-pins.png", mime: "image/png" },
  { path: "assets/textures/earth-nightmap-inline-visible-2048.jpg", mime: "image/jpeg" },
];
